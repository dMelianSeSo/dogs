...
import Context from "../context/LoggedUser.tsx";
      ...
      <Container>
        {loading && (
          <div className="text-center">
            <h2>Loading...</h2>
            <FontAwesomeIcon className="fa-spin" icon={faCog} size="4x" />
          </div>
        )}
        <Row>
          {dogs.length > 0 &&
            dogs.map((dog) => <DogCard dog={dog} key={dog.id} votes={votes} />)}
        </Row>
        {user.length > 0 && (
          <Row className="mt-2">
